          ...
          >
            <div className="process__item mb-100">
              ...
              <div className="process__content">
                ...
                <p>
                  Clarifying Vision, Capturing Needs — We Help You Define
                  Requirements with Precision and Purpose
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="process__item mb-100">
              ...
              <div className="process__content">
                ...
                <p>
                  Transforming Ideas into Tangible Experiences — Fast, Focused
                  Design and Prototyping That Accelerates Innovation
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="process__item">
              ...
              <div className="process__content">
                ...
                <p>
                  Delivering Scalable, Ready-to-Deploy Solutions That Drive
                  Real-World Results
                </p>
              </div>
            </div>
